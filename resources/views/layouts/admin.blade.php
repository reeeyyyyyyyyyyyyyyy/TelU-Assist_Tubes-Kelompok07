...
<head>
    ...
    <title>Admin Dashboard - Tel-U Assist</title>
    ...
    <div class="flex min-h-screen">
        ...
        <div class="sidebar w-64 min-h-screen py-6 px-4">
            ...
            <nav class="space-y-1">
                ...
                <a href="{{ route('admin.users') }}" class="nav-link {{ request()->routeIs('admin.users') ? 'active' : '' }} block py-3 px-4 rounded-lg">
                ...
                <a href="{{ route('location.index') }}" class="nav-link {{ request()->routeIs('location.index') ? 'active' : '' }} block py-3 px-4 rounded-lg">
                    <i class="fas fa-map-marker-alt mr-3"></i> Master Location
                </a>
                <a href="{{ route('reportcategory.index') }}" class="nav-link {{ request()->routeIs('reportcategory.index') ? 'active' : '' }} block py-3 px-4 rounded-lg">
                    <i class="fas fa-tags mr-3"></i> Master Report Category
                </a>
        ...
        <div class="flex-1 flex flex-col" style="width: 50%">
            ...
            <header class="bg-white py-4 px-6 flex justify-between items-center shadow">
                <div>
                    <h2 class="text-xl font-semibold text-campus">@yield('page-title', 'Dashboard')</h2>
                </div>
